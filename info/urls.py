...
from .views import EmployeeDashboardDataAPIView, EmployeeReviewDatAPIView, ShootOtpToEmployeeAPIView,VerifyOtpLoginAPIView,EmployeeOrganizationDataPIView
urlpatterns = [
